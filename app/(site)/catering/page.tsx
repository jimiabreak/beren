...
import { SITE_SETTINGS_QUERY, HEADER_QUERY, FOOTER_QUERY, CATERING_PAGE_QUERY } from '@/sanity/lib/queries'
...
export default async function CateringPage() {
  const [{ data: settings }, { data: headerData }, { data: footerData }, { data: pageData }] = await Promise.all([
    ...
    sanityFetch({ query: CATERING_PAGE_QUERY, tags: ['cateringPage'] }),
  ])
  ...
  return (
    <>
      ...
      <main id="main">
        <CateringContent pageData={pageData} />
      </main>
